...
using MyCompanyName.MyProjectName.Common.Samples;
using Volo.Abp.DependencyInjection;
using Volo.Abp.IdentityModel;

namespace MyCompanyName.MyProjectName.Common;

public class ClientCommonDemoService : ITransientDependency
{
    private readonly ISampleAppService _sampleAppService;
    private readonly IIdentityModelAuthenticationService _authenticationService;
    private readonly IConfiguration _configuration;

    public ClientCommonDemoService(
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:MyProjectNameCommon:BaseUrl"] +
                      "api/MyProjectName/common/sample/authorized";
