...
using MyCompanyName.MyProjectName.Public.Samples;
using Volo.Abp.DependencyInjection;
using Volo.Abp.IdentityModel;

namespace MyCompanyName.MyProjectName.Public;

public class ClientPublicDemoService : ITransientDependency
{
    private readonly ISampleAppService _sampleAppService;
    private readonly IIdentityModelAuthenticationService _authenticationService;
    private readonly IConfiguration _configuration;

    public ClientPublicDemoService(
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:MyProjectNamePublic:BaseUrl"] +
                      "api/MyProjectName/public/sample/authorized";
