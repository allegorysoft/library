...
using MyCompanyName.MyProjectName.Admin.Samples;
using Volo.Abp.DependencyInjection;
using Volo.Abp.IdentityModel;

namespace MyCompanyName.MyProjectName.Admin;

public class ClientAdminDemoService : ITransientDependency
{
    private readonly ISampleAppService _sampleAppService;
    private readonly IIdentityModelAuthenticationService _authenticationService;
    private readonly IConfiguration _configuration;

    public ClientAdminDemoService(
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:MyProjectNameAdmin:BaseUrl"] +
                      "api/MyProjectName/admin/sample/authorized";
