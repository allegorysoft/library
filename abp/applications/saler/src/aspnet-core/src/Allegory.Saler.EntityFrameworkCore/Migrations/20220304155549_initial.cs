    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUnitGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppClientUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppClientUsers_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Statu = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppItems_AppUnitGroups_UnitGroupId",
                        column: x => x.UnitGroupId,
                        principalTable: "AppUnitGroups",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppServices_AppUnitGroups_UnitGroupId",
                        column: x => x.UnitGroupId,
                        principalTable: "AppUnitGroups",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MainUnit = table.Column<bool>(type: "bit", nullable: false),
                    ConvFact1 = table.Column<double>(type: "float", nullable: false),
                    ConvFact2 = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUnits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUnits_AppUnitGroups_UnitGroupId",
                        column: x => x.UnitGroupId,
                        principalTable: "AppUnitGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppOrderLines_AppUnits_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppClients_Code",
                table: "AppClients",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppClientUsers_ClientId_UserId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "AppOrderLines",
                columns: new[] { "Type", "StockId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppOrderLines_UnitId",
                table: "AppOrderLines",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppServices_UnitGroupId",
                table: "AppServices",
                column: "UnitGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUnitGroups_Code",
                table: "AppUnitGroups",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppUnits_UnitGroupId_Code",
                table: "AppUnits",
                columns: new[] { "UnitGroupId", "Code" },
                unique: true);
