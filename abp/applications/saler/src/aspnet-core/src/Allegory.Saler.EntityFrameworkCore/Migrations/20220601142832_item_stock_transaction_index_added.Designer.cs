...
namespace Migrations
{
    ...
    [Migration("20220601142832_item_stock_transaction_index_added")]
    partial class item_stock_transaction_index_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Allegory.Saler.Clients.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allegory.Saler.ClientUsers.ClientUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppClientUsers", (string)null);
                });

            modelBuilder.Entity("Allegory.Saler.Currencies.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allegory.Saler.Currencies.CurrencyDailyExchange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Date", "CurrencyId")
                        .IsUnique();

                    b.ToTable("AppCurrencyDailyExchanges", (string)null);
                });

            modelBuilder.Entity("Allegory.Saler.Items.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<short?>("PurchaseDeductionPart1")
                        .HasColumnType("smallint");

                    b.Property<short?>("PurchaseDeductionPart2")
                        .HasColumnType("smallint");

                    b.Property<byte>("PurchaseVatRate")
                        .HasColumnType("tinyint");

                    b.Property<short?>("SalesDeductionPart1")
                        .HasColumnType("smallint");

                    b.Property<short?>("SalesDeductionPart2")
                        .HasColumnType("smallint");

                    b.Property<byte>("SalesVatRate")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Allegory.Saler.Items.ItemStockTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte>("Statu")
                        .HasColumnType("tinyint");

                    b.Property<int>("TransactionId")
                        .HasColumnType("int");

                    b.Property<int>("TransactionParentId")
                        .HasColumnType("int");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ItemId", "Date"), new[] { "Quantity", "IsOutput", "Statu" });

                    b.HasIndex("Type", "TransactionParentId");

                    b.HasIndex("Type", "TransactionId", "IsOutput")
                        .IsUnique();

                    b.ToTable("AppItemStockTransactions", (string)null);
                });

            modelBuilder.Entity("Allegory.Saler.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("TotalVatBase")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Allegory.Saler.Orders.OrderDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppOrderDiscounts", (string)null);
                });

            modelBuilder.Entity("Allegory.Saler.Orders.OrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<short?>("DeductionPart1")
                        .HasColumnType("smallint");

                    b.Property<short?>("DeductionPart2")
                        .HasColumnType("smallint");
                    ...
                    b.Property<double?>("ReserveQuantity")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Allegory.Saler.Orders.OrderLineDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppOrderLineDiscounts", (string)null);
                });

            modelBuilder.Entity("Allegory.Saler.Services.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allegory.Saler.UnitPrices.UnitPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Type", "ProductId", "BeginDate", "EndDate");

                    b.ToTable("AppUnitPrices", (string)null);
                });

            modelBuilder.Entity("Allegory.Saler.Units.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("ConvFact1")
                        .HasColumnType("float");

                    b.Property<double>("ConvFact2")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("UnitGroupId", "Code")
                        .IsUnique();

                    b.ToTable("AppUnits", (string)null);
                });

            modelBuilder.Entity("Allegory.Saler.Units.UnitGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppUnitGroups", (string)null);
                });
            ...
            modelBuilder.Entity("Allegory.Saler.ClientUsers.ClientUser", b =>
                {
                    b.HasOne("Allegory.Saler.Clients.Client", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Allegory.Saler.Currencies.CurrencyDailyExchange", b =>
                {
                    b.HasOne("Allegory.Saler.Currencies.Currency", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Allegory.Saler.Items.Item", b =>
                {
                    b.HasOne("Allegory.Saler.Units.UnitGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Allegory.Saler.Items.ItemStockTransaction", b =>
                {
                    b.HasOne("Allegory.Saler.Items.Item", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Allegory.Saler.Orders.OrderDiscount", b =>
                {
                    b.HasOne("Allegory.Saler.Orders.Order", null)
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("Allegory.Saler.Orders.OrderLine", b =>
                {
                    ...
                    b.HasOne("Allegory.Saler.Units.Unit", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Allegory.Saler.Orders.OrderLineDiscount", b =>
                {
                    b.HasOne("Allegory.Saler.Orders.OrderLine", null)
                        .WithMany("Discounts")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
